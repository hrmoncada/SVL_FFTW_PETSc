...
# undef __FUNCT__
# define __FUNCT__ "SVL_2D_FFTW_SWAP_METHOD_1"
PetscErrorCode SVL_2D_FFTW_SWAP_METHOD_1(PetscInt Nx, PetscInt Ny, PetscReal* U, PetscScalar* AC) {
...
/*             1. 1D FFT on each Horizontal Row              */
/*             2. 1D FFT on each Vertical Column             */
/*************************************************************/
...
/*************************************************************/
  for (i = 0; i < Nx; i++) { // Loop through the columns.
